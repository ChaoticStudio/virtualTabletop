...
@Component({
  ...
  <div class="skill full-width" [formGroup]="group" >
    <mat-checkbox class="skill-checkbox" [formControlName]="field.name"></mat-checkbox>
    
    <mat-form-field class="skill-input-field" [formGroup]="group">
      <input class="skill-input" matInput [formControlName]="field.name" placeholder="{{placeholder}}" type="number" max="999" (input)="onValueChange($event.target.value)">
    </mat-form-field>
