...
export class AreaOfEffectService {
  ...
  drawCircle (positionX, positionY, radius, pixelSize, context: CanvasRenderingContext2D, color = 'rgba(255, 255, 102, .75)') {
  ...
  drawPixel(positionX, positionY, pixelSize, context: CanvasRenderingContext2D, color = 'rgba(255, 255, 102, .75)') {
